...
You can add/change any of the sayings in the program by adding
  ...
  Also, while it does have a WIFI access point, its a little glitchy.  You'll get a random mis-fire every now and again.  Its either a limitation of my programing knowledge or a limitation of the hardware I used.  Once you access the WIFI, it'll be glitchy until its reset, even if you leave the WIFI.
